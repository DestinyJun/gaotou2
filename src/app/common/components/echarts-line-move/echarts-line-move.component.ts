...
@Component({
  selector: 'app-echarts-line-move',
  templateUrl: './echarts-line-move.component.html',
  styleUrls: ['./echarts-line-move.component.less']
})
export class EchartsLineMoveComponent implements OnInit, OnChanges, OnDestroy {
  @Input() public option: any;
  @Input() public height: any;
  @Input() public width = 'auto';
  public lineMoveOption = {};
  ...
  // 统计图渲染
  public areaChartFun() {
    const XName = this.option.data.xdata;
    const data1 = [];
    const data2 = [];
    ...
    const color = ['#00f8ff', '#00f15a', '#0696f9', '#dcf776'];
