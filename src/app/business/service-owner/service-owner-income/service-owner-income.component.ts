...
@Component({
  selector: 'app-service-owner-income',
  templateUrl: './service-owner-income.component.html',
  styleUrls: ['./service-owner-income.component.less']
})
export class ServiceOwnerIncomeComponent implements OnInit, OnChanges, OnDestroy {
  @Input() serviceId: any;
