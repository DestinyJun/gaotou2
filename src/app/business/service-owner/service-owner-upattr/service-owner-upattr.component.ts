...
@Component({
  selector: 'app-service-owner-upattr',
  templateUrl: './service-owner-upattr.component.html',
  styleUrls: ['./service-owner-upattr.component.less']
})
export class ServiceOwnerUpattrComponent implements OnInit {
  @Input() public incomeTopData: any;
