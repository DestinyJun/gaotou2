...
@Component({
  selector: 'app-service-owner-car',
  templateUrl: './service-owner-car.component.html',
  styleUrls: ['./service-owner-car.component.less']
})
export class ServiceOwnerCarComponent implements OnInit, OnChanges, OnDestroy {
