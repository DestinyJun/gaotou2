...
@Component({
  selector: 'app-service-owner-info',
  templateUrl: './service-owner-info.component.html',
  styleUrls: ['./service-owner-info.component.less'],
})
export class ServiceOwnerInfoComponent implements OnInit, OnChanges {
  @Input() serviceId: any;
