...
@Component({
  selector: 'app-service-owner-3d',
  templateUrl: './service-owner-3d.component.html',
  styleUrls: ['./service-owner-3d.component.less']
})
export class ServiceOwner3dComponent implements OnInit, OnChanges {
