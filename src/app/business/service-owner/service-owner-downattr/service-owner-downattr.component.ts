...
@Component({
  selector: 'app-service-owner-downattr',
  templateUrl: './service-owner-downattr.component.html',
  styleUrls: ['./service-owner-downattr.component.less']
})
export class ServiceOwnerDownattrComponent implements OnInit {
